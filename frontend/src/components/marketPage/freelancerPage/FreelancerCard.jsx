        ...
        <CardContent sx={{ display: "flex", alignItems: "center" }}>
            ...
            <Box sx={{ flexGrow: 1 }}>
                <Typography variant="h6" fontWeight="bold">
                    {freelancer.display_name} <Typography variant="body2" component="span" color="text.secondary">({freelancer.role})</Typography>
                </Typography>
                ...
                <Stack direction="row" spacing={2} alignItems="center">
                    ...
                    <Typography variant="body2" color="text.secondary">
                        {freelancer.rating?.toFixed(1) || "0.0"} ({freelancer.completed_jobs || 0} jobs)
                    </Typography>
                    {freelancer.is_verified && (
                        <Chip label="Verified" color="success" size="small" />
                    )}
                    <Chip label={freelancer.availability || "Available"} color="info" size="small" />
                </Stack>
            </Box>
